...
export default class Bluetooth {
  ...
  openAndListenBluetoothAdapter() {
    ...
    if (!this.isInitializedAdapter) {
      ...
      // 监听蓝牙适配器状态
      _.api('offBluetoothAdapterStateChange', undefined, () => {}).then(__ => __).catch(__ => __);
      _.on('onBluetoothAdapterStateChange',undefined ,(res) => {
      ...
      //   })
      return _.api('openBluetoothAdapter').then(res => {
            this.bm.log('openBluetoothAdapter success', res);
            this.isInitializedAdapter = true;
            this.isAvailableAdapter = true;
            return Promise.resolve();
